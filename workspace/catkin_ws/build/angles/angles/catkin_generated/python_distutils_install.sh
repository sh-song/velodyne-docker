...
echo_and_run cd "/workspace/catkin_ws/src/angles/angles"
...
echo_and_run /usr/bin/env \
    ...
    egg_info --egg-base /workspace/catkin_ws/build/angles/angles \
    build --build-base "/workspace/catkin_ws/build/angles/angles" \
    install \
    --root="${DESTDIR-/}" \
