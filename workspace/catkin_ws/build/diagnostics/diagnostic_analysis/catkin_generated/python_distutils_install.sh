...
echo_and_run cd "/workspace/catkin_ws/src/diagnostics/diagnostic_analysis"
...
echo_and_run /usr/bin/env \
    ...
    egg_info --egg-base /workspace/catkin_ws/build/diagnostics/diagnostic_analysis \
    build --build-base "/workspace/catkin_ws/build/diagnostics/diagnostic_analysis" \
    install \
    --root="${DESTDIR-/}" \
