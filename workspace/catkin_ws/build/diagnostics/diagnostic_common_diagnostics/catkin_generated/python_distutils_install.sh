...
echo_and_run cd "/workspace/catkin_ws/src/diagnostics/diagnostic_common_diagnostics"
...
echo_and_run /usr/bin/env \
    ...
    egg_info --egg-base /workspace/catkin_ws/build/diagnostics/diagnostic_common_diagnostics \
    build --build-base "/workspace/catkin_ws/build/diagnostics/diagnostic_common_diagnostics" \
    install \
    --root="${DESTDIR-/}" \
