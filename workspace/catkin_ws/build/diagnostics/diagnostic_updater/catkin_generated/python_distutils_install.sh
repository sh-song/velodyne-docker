...
echo_and_run cd "/workspace/catkin_ws/src/diagnostics/diagnostic_updater"
...
echo_and_run /usr/bin/env \
    ...
    egg_info --egg-base /workspace/catkin_ws/build/diagnostics/diagnostic_updater \
    build --build-base "/workspace/catkin_ws/build/diagnostics/diagnostic_updater" \
    install \
    --root="${DESTDIR-/}" \
