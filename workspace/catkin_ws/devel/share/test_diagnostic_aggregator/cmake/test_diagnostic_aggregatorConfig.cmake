...
if("TRUE" STREQUAL "TRUE")
  set(test_diagnostic_aggregator_SOURCE_PREFIX /workspace/catkin_ws/src/diagnostics/test_diagnostic_aggregator)
  set(test_diagnostic_aggregator_DEVEL_PREFIX /workspace/catkin_ws/devel)
  ...
  set(test_diagnostic_aggregator_INSTALL_PREFIX /workspace/catkin_ws/install)
...
if(NOT "/workspace/catkin_ws/src/diagnostics/test_diagnostic_aggregator/include " STREQUAL " ")
  set(test_diagnostic_aggregator_INCLUDE_DIRS "")
  set(_include_dirs "/workspace/catkin_ws/src/diagnostics/test_diagnostic_aggregator/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'test_diagnostic_aggregator' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/workspace/catkin_ws/src/diagnostics/test_diagnostic_aggregator/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /workspace/catkin_ws/devel/lib;/opt/ros/melodic/lib)
